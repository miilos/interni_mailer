 ...
 */
final class Version20250730090830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE email_template ADD CONSTRAINT FK_9C0600CACC4E68B8 FOREIGN KEY (body_template_id) REFERENCES email_body (id)
        SQL);
        $this->addSql(<<<'SQL'
